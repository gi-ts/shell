...
export class ScanoutError extends GLib.Error {
...
export abstract class Framebuffer extends GObject.Object {
    static $gtype: GObject.GType<Framebuffer>;

    constructor(properties?: Partial<Framebuffer.ConstructorProperties>, ...args: any[]);
    _init(...args: any[]): void;
